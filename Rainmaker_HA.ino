...
void sysProvEvent(arduino_event_t *sys_event)
{
  switch (sys_event->event_id) {
    case ARDUINO_EVENT_PROV_START:
      ...
      Serial.printf("nProvisioning Started with name "%s" and PoP "%s" on BLEn", service_name, pop);
      printQR(service_name, pop, "ble");
#else
      Serial.printf("nProvisioning Started with name "%s" and PoP "%s" on SoftAPn", service_name, pop);
      printQR(service_name, pop, "softap");
#endif
      break;
    case ARDUINO_EVENT_WIFI_STA_CONNECTED:
      Serial.printf("nConnected to Wi-Fi!n");
...
void setup()
{
  ...
  Serial.printf("nStarting ESP-RainMakern");
  RMaker.start();
